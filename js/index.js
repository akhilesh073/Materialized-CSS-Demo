...
/*salaryMap.forEach(function (key, value) {
	var dp = {
		    category: i,
		    value: i
		  };
...
//	var graphData= {
//		    "data":[
//		            {"salary":"100000","count":"20"},
//		            {"salary":"32000","count":"40"},
//		            {"salary":"10001","count":"60"},
//		            {"salary":"320023","count":"30"},
//		        ]
//		    };
	var obj = JSON.parse(graphData);
	var data = obj.data;
	console.log("graphData: "+graphData);
	console.log("type of graphData: "+typeof(graphData));
	console.log("obj: "+obj);
	console.log("type of obj: "+typeof(obj));
	console.log("data1: "+obj.data);

	for(var i in data)
	{
	     var salary = data[i].salary;
	     var count = data[i].count;
	     console.log("salary: "+salary+" , count: "+count);
         dp = {
        		    category: salary,
        		    value: count
        		  };
        		  
        		  /*if ( verticals.indexOf( Math.round( key * 10 ) / 10 ) !== -1 ) {
...
/* var graphData = [ {
    ...
    "balloonText": "[[category1]]: <b>[[value1]]</b>",
    "lineThickness": 3,
    "valueField": "value1"
  }
  ]*/
